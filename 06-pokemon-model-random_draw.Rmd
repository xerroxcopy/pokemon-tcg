...
というかEeveeが2位だと思ってたのだがCharizard?pokemon_nameとNameでだいぶ違うのだろう。Charizardという名前Nameでは少ないけど、Charizardというポケモンpokemon_nameでは多いということ。つまりEeveeよりもリミックスされがちだということだ！
...
df_empirical_count_remix <- 
  ...
  ungroup() |> 
  select(starts_with("count_"), id, name_type, Name, pokemon_name) |> 
  distinct() |> 
