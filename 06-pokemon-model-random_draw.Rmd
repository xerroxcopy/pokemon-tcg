...
ggsave("./output/emp_release-date.svg", width = 166, height = 60, unit = "mm")
...
ggsave("./output/temporal-change-cumulative.png", width = 75, height = 30, unit = "mm", dpi = 600)
