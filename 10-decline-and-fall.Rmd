...
df_no_appearance_residual <- full_join(
  df_no_appearance_emp2 |> select(-condition), df_no_appearance_sim |> select(-condition), by = c("series_gen_era", "pokemon_gen")
  ) |> 
...
<!--   decline_and_fall_of_pokemon_empire_df |>  # click series_gen_era, pokedex_id then condition -->
<!--   ungroup() |>  -->
<!--   group_by(condition, pokedex_id) |>  -->
<!--   mutate( -->
<!--     previous_relative_rank = lead(relative_rank, order_by = series_gen_era), -->
...
<!-- decline_and_fall_of_pokemon_empire_df2 |>  -->
<!--   ungroup() |>  -->
<!--   group_by(condition, series_gen_era) |>  -->
...
<!--   filter(condition == "pokemon name") |>  -->
<!--   ungroup() |>  -->
<!--   select(n, pokedex_id, series_gen_era, pokemon_gen) |> distinct() -->
...
<!-- #   filter(condition == "pokemon name") -->
<!-- df_top_pokemon |>  -->
<!--   ggplot(aes(x = series_gen_era, y = n)) + -->
<!--   geom_quasirandom( -->
