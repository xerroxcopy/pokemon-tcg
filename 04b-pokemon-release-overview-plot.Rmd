...
ggplot(aes(x = release_date, y = id)) +
  ...
  # ) +
  # scale_colour_manual(
  #   values = c("greenyellow", "transparent", "royalblue3")
  # ) +
  # geom_count( # 初出
  #   data = df_gene_first_last |> 
  #     filter(name == "first_appeared"),
  #   aes(x = date), 
  #   fill = NA,
  #   pch = 21,
  #   stroke = .1,
  ...
  # geom_count( # 最終登場
  #   data = df_gene_first_last |> 
  #     filter(name == "last_appeared"),
  #   aes(x = date),
  #   fill = NA,
  #   pch = 21,
  #   stroke = .1,
  #   colour = "blue") +
  # geom_text( # 最終登場が早すぎるやつをハイライトできるようにする場合
  #   data = df_gene_first_last |> filter(name == "last_appeared"), 
  #   aes(x = date, label = pokemon_name), 
  #   size = 3,
  #   colour = "blue", 
  #   hjust = 0) +
  scale_size(
...
ggsave("./output/emp_release-date.png", width = 83, height = 60, unit = "mm", dpi = 600) 
