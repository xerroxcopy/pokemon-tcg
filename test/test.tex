...
\affiliation[1]{organization={Some Institute of
Technology}, addressline={Street
...
\begin{keyword}
    ...
    keyword2
\end{keyword}
\end{frontmatter}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, borderline west={3pt}{0pt}{shadecolor}, interior hidden, sharp corners, breakable, boxrule=0pt, frame hidden]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{test_files/figure-pdf/fig-meaningless-1.pdf}
